...
class TestDataCleaner:
    ...
    def sample_data(self):
        ...
        data = {
            'Product': ['Credit card', 'Personal loan', 'Savings account', 
                       'Credit card', 'Other product', 'Money transfers'],
    ...
    def test_filter_by_products(self, sample_data):
        ...
        assert len(result) == 4
        assert set(result['Product'].unique()) == set(target_products)
    ...
    def test_remove_empty_narratives(self, sample_data):
        ...
        result = cleaner.remove_empty_narratives(sample_data, 'Consumer complaint narrative')
    ...
    def test_clean_all_narratives(self, sample_data):
        ...
        data_with_narratives = cleaner.remove_empty_narratives(sample_data, 'Consumer complaint narrative')
        
        result = cleaner.clean_all_narratives(data_with_narratives, 'Consumer complaint narrative')
